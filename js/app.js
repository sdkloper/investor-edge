...
function renderCompTab(type, subject, comps) {
  ...
  let html = `
    ...
    <p>
      <strong>
        <a href="https://www.saulkloper.com/listing-details?property_id=md257_${subject.MLS}" target="_top" rel="noopener noreferrer">
          ${subject.Address || ""}
        </a>
      </strong>
    </p>
      ...
      if (type === "sales") {
        html += `
          <p class="${highlightClass}">
            <a href="https://www.saulkloper.com/listing-details?property_id=md257_${comp["MLS Number"] || ""}" target="_top" rel="noopener noreferrer">
              ${comp.Address || ""}
            </a><br>
...
function renderTable() {
  ...
  filtered.forEach((row) => {
   ...
   tr.innerHTML = `
     <td>${icons}
        <a href="https://www.saulkloper.com/listing-details?property_id=md257_${row.MLS}" target="_top" rel="noopener noreferrer">
          ${row.MLS}
        </a>
      </td>
