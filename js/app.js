...
function renderCompTab(type, subject, comps) {
  ...
  let html = `
    ...
    <p>
      <strong>
        <a href="https://entourageelite.com/properties/listing/Bright/${subject.MLS}" target="_blank" rel="noopener noreferrer">
          ${subject.Address || ""}
        </a>
      </strong>
    </p>
      ...
      if (type === "sales") {
        html += `
          <p class="${highlightClass}">
            <a href="https://entourageelite.com/properties/listing/Bright/${comp["MLS Number"] || ""}" target="_blank" rel="noopener noreferrer">
              ${marker}${comp.Address || ""}
            </a>
            </a><br>
...
function renderTable() {
  ...
  filtered.forEach((row) => {
   ...
   tr.innerHTML = `
     <td>${icons}
        <a href="https://entourageelite.com/properties/listing/Bright/${row.MLS}" target="_blank" rel="noopener noreferrer">
          ${row.MLS}
        </a>
      </td>
